# Descargar APK de "Clave del Día"

## Opción Recomendada: Progressive Web App (PWA)
...
## Alternativa: APK Descargable (Solo Android)

Si prefieres descargar un APK directo, puedes compilarlo usando EAS Build:
...
4. **Descargar cuando esté listo:**
   - EAS generará un enlace de descarga
...
✅ **Período de Prueba**: 15 días desde la instalación  
...
"Clave del Día" es una aplicación de prueba con período limitado de 15 días desde su descarga/instalación.
